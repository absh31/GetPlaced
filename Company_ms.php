...
if (isset($_POST['app_stud'])) {
    ...
    $link = $_POST['link'];
    $sql = $conn->prepare("UPDATE `application_tbl` SET `is_approved`= 1 , `link`='$link' , `app_date`= '$app_date' , `app_time`= '$app_time' where `app_id` = $app_id ");
    $sql->execute();
            ...
            <div class="page-content p-5 bg-white" id="content">
                ...
                <div class="titles" id="company_dashboard">
                    ...
                    <div class="card-deck mb-4">
                        ...
                        ?>
                                ...
                                <div class="card text-dark">
                                    <div class="card-header font-weight-bold">
                                        Applicant : <a href="./SeekView.php?id=<?php echo $applicant; ?>" target="_blank"><?php echo $applicant; ?></a>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-10">
                            <div style="font-size:12pt;">
                                <table class="table text-center">
                                    <thead>
                                        <tr>
                                            <th style="border-bottom:2px solid #2a2868 !important" scope="col">Application ID</th>
                                            ...
                                            <th style="border-bottom:2px solid #2a2868 !important" scope="col">Enrollment No.</th>
                                            <th style="border-bottom:2px solid #2a2868 !important" scope="col">Email</th>
                                            <th style="border-bottom:2px solid #2a2868 !important" scope="col">View CV</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tableBody">

                                        <?php
                                        $sql = $conn->prepare("SELECT * FROM `application_tbl` WHERE `company_name` = '$name' AND `is_approved`=0");
                                        $sql->execute();
                                        if ($sql->rowCount() > 0) {
                                            while ($row = $sql->fetch()) {
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="./SeekView.php?id=<?php echo $uname; ?>" target="_blank"><?php echo $name2; ?></a></th>
                                                    <td><?php echo $college; ?></td>
                                                    <td><?php echo $branch; ?></td>
                                                    <td><?php echo $enroll; ?></td>
                                                    <td><?php echo $mail; ?></td>
                                                    <td><a href="./uploads/cvs/<?php echo $cv; ?>" target="_blank"><button class="btn btn-primary text-light">View</button></a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                            ...
                            ?>
                                <td>
                                    <form class="g-1" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
                                        <div class="col-md-6">
                                            <label for="app_id" class="form-label" style="font-family:Product Sans">Application ID</label>
                                            <input type="number" name="app_id" placeholder="Application ID in First Column">
                                        </div>
                                        <br>
                                        <div class="col-md-6">
                                            <label for="date" class="form-label" style="font-family:Product Sans">Date Of Interview</label>
                                            <input type="date" name="app_date" placeholder="Date of Interview">
                                        </div>
                                        <br>
                                        <div class="col-md-6">
                                            <label for="time" class="form-label" style="font-family:Product Sans">Time of Interview</label>
                                            <input type="text" name="app_time" placeholder="Time of Interview">
                                        </div>
                                        <br>
                                        <div class="col-md-6">
                                            <label for="time" class="form-label" style="font-family:Product Sans">Link for Interview</label>
                                            <input type="text" name="link" placeholder="Link for Interview">
                                        </div>
                                        <br>
                                        <button class="btn btn-primary text-light" type="submit" name="app_stud">Approve</button>
                                    </form>
                                <?php } ?>
                ...
                <div class="titles" id="company_profile">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="panel-body bio-graph-info">
                                ...
                                <div class="row">
                                    <div class="bio-row">
                                        <p><span>Name </span>: <?php echo $fname; ?></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Location </span>: <?php echo $lname; ?></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Contact</span>: <?php echo $dob; ?></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Email</span>: <?php echo $college; ?></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Website</span>: <?php echo $branch; ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="text-left text-dark mt-4">
                    ...
                    <div class="text-left text-dark">
                        ...
                        <h4 style="font-family: Product Sans;font-weight: 800;font-size: 16pt;color:#2a2868;margin-bottom:30px;"><?php echo $about; ?></h4>
                    </div>
                    <div class="col-lg-5 col-md-6" style="font-family: Product Sans;font-weight: 100;font-size: 16pt;color:#2a2868">
                        Name : <?php echo $name; ?>
                        <br>
                        <br>
                    ...
                    <div class="row">
                        ...
                        <form class="row g-3" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="Drivestart_date" class="form-control border border-dark" id="inputdate">
                            </div>
                            <div class="col-md-6">
                                <label for="date" class="form-label" style="font-family:Product Sans">End Date</label>
                                <input type="date" name="Driveend_date" class="form-control border border-dark" id="inputdate">
                            </div>
                            <div class="col-md-6">
                                <label for="time" class="form-label" style="font-family:Product Sans">Time</label>
                                <input type="text" name="Drivetime" class="form-control border border-dark" id="password" placeholder="12.00 - 17.00 Hrs.">
                            </div>
                            <div class="col-md-6">
                                <label for="requirements" class="form-label" style="font-family:Product Sans">Platform</label>
                                <input type="text" name="platform" class="form-control border border-dark" id="requirements" placeholder="Platform">
                            </div>
                            <div class="col-md-6">
                                <label for="requirements" class="form-label" style="font-family:Product Sans">Total Number of Requirements</label>
                                <input type="number" name="require" placeholder="Number of Intake" class="form-control border border-dark" id="requirements">
                            </div>
                            <div class="col-md-6">
                                <label for="requirements" class="form-label" style="font-family:Product Sans">Package</label>
                                <input type="text" name="package" placeholder="4.00 to 8.00 LPA" class="form-control border border-dark" id="requirements">
                            </div>
                            <div class="col-md-6">
                                <label for="requirements" class="form-label" style="font-family:Product Sans">Attachment</label>
                                <input type="file" name="attach" class="form-control border border-dark" id="requirements">
                            </div>
                            <div class="col-6">
                                <br>
                                <button class="btn btn-primary" type="submit" name="drive" style="background-color:#2a2868;border:solid 2px green">Schedule Drive</button>
                            </div>
                        </form>
                        ...
                        <div style="font-size:12pt; color: #2a2868;">
                            <table class="table text-center table-bordered">
                                ...
                                <tbody id="tableBody">
                                    ...
                                    <?php
                                    //for college placement drives...
                                    $sql = $conn->prepare("SELECT * FROM `schedule_drive` WHERE `company_name` = '$name' and `is_app_college`= 0");
                                    $sql->execute();
                                    if ($sql->rowCount() > 0) {
                                        while ($row = $sql->fetch()) {
                                            //echo json_encode($row);
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dates; ?></td>
                                                <td><?php echo $time; ?></td>
                                                <td><a href="<?php echo $att; ?>" target='_blank'><button class="btn btn-primary text-light">View</button></a></td>
                                                <!--  -->
